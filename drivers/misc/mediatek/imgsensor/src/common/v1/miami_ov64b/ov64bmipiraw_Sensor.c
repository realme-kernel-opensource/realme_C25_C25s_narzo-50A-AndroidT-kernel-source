...
#define PFX "MIAMI_OV64B40_camera_sensor"
...
#define VCM_REG_MIAMI 0xD2
static unsigned char ov64b_vcm_id = 0;
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = MIAMI_OV64B_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    do {
        ...
        *sensor_id = return_sensor_id();
        LOG_INF("zyd3 return sensor id: 0x%x\n", return_sensor_id());
        if (*sensor_id == MIAMI_OV64B_SENSOR_ID) {
            *sensor_id = imgsensor_info.sensor_id;
            ...
            if(ov64b_vcm_id == VCM_REG_MIAMI) {
                read_EepromQSC();
                LOG_INF("Find ov64b_miami,vcm ID = 0x%x\n", ov64b_vcm_id);
                //return ERROR_NONE;
            } else {
