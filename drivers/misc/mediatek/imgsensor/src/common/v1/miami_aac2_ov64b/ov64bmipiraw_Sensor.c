...
#define PFX "MIAMI_AAC2_OV64B40_camera_sensor"
...
#define VCM_ADDR 0x000A
#define VCM_REG_MIAMI 0xB6
static int ov64b_vcm_id = 0;
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = MIAMI_AAC2_OV64B_SENSOR_ID,
    ...
    .slim_video = { /* 4608*3456@30fps */
        ...
        .startx = 8,
        .starty = 6,
        .grabwindow_width = 4624,//4608
        .grabwindow_height = 2600,//3456
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 679680000,
        .max_framerate = 300,
    },
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
    ...
    {9280, 6944, 384, 640, 8512, 5664, 4256, 2832, 208, 336, 3840, 2160, 0, 0, 3840, 2160}, /*custom2*/
    {9280, 6944,  0,   0, 9280, 6944, 9280, 6944,16, 4, 9248, 6936, 0, 0, 9248, 6936}, /*custom3*/
    {9280, 6944, 16,   0, 9248, 6944, 4624, 3472, 312, 236, 4000, 3000, 0, 0, 4000, 3000}, /*custom4*/
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[4] = {
    ...
    /*4624*2600 1136(pxiel)*648 568pixel/line*(648*2)line */
    {
        ...
        0x01, 0x2B, 0x058C, 0x0280, 0x03, 0x00, 0x0000, 0x0000
    },
    /* 3840*2160 960(pxiel)*540 568pixel/line*(748*2)line*/
    {
        0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
        0x00, 0x2b, 0x0FA0, 0x08D0, 0x00, 0x00, 0x0280, 0x0001,
        0x01, 0x2B, 0x04B0, 0x021C, 0x03, 0x00, 0x0000, 0x0000
    },
     /* custom4 mode setting 4000*3000 PD 992*748*/
    {
        0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
        0x00, 0x2b, 0x0FA0, 0x08D0, 0x00, 0x00, 0x0280, 0x0001,
        0x01, 0x2B, 0x04D8, 0x02EC, 0x03, 0x00, 0x0000, 0x0000
    },
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
     ...
     .i4BlockNumX = 284,
     .i4BlockNumY = 215,
     .i4Crop = { {0, 2}, {0, 2}, {0, 436}, {1000, 936}, {0, 436},
         {0, 2}, {0, 436}, {0, 0}, {1000, 936}, {0, 234} },
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_custom2 = {
     ...
     .i4BlockNumY = 135,
     .i4Crop = { {0, 2}, {0, 2}, {0, 436}, {1000, 936}, {0, 436},
         {0, 2}, {392, 656}, {0, 0}, {1000, 936}, {0, 234} },
     .iMirrorFlip = 3,     /*0 IMAGE_NORMAL, 1 IMAGE_H_MIRROR, 2 IMAGE_V_MIRROR, 3 IMAGE_HV_MIRROR */
};
...
static void read_EepromQSC(void)
{
    ...
    for (i = 0; i < 720; i ++) {
        ...
        LOG_INF("ov64b_QSC_OVPD_setting[2*i][%d]:0x%x\n",2*i, ov64b_QSC_OVPD_setting[2*i]);
        LOG_INF("ov64b_QSC_OVPD_setting[2*i+1][%d]:0x%x\n",2*i+1, ov64b_QSC_OVPD_setting[2*i+1]);
    }
    /*Read crosstalk*/
    for (i = 0; i < 288; i ++) {
        ov64b_QSC_CT_setting[2*i] = senaddr_crotalk+i;
        ov64b_QSC_CT_setting[2*i+1] = Eeprom_1ByteDataRead((addr_crotalk+i), 0xA0);
        LOG_INF("ov64b_QSC_CT_setting[2*i]%d]:0x%x\n",2*i, ov64b_QSC_CT_setting[2*i]);
        LOG_INF("ov64b_QSC_CT_setting[2*i+1][%d]:0x%x\n",2*i+1, ov64b_QSC_CT_setting[2*i+1]);
    }
    ...
    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
       ...
       LOG_INF("gImgEepromInfo.camNormdata[0][8+i]:0x%x\n", gImgEepromInfo.camNormdata[0][8+i]);
    }

    //Dac_mac
    gImgEepromInfo.camNormdata[0][28] = Eeprom_1ByteDataRead(0x92, 0xA0);//Dac_mac_l
    gImgEepromInfo.camNormdata[0][29] = Eeprom_1ByteDataRead(0x93, 0xA0);//Dac_mac_h
    //Dac_inf
    gImgEepromInfo.camNormdata[0][34] = Eeprom_1ByteDataRead(0x94, 0xA0);//Dac_inf_l
    gImgEepromInfo.camNormdata[0][35] = Eeprom_1ByteDataRead(0x95, 0xA0);//Dac_inf_h

    LOG_INF("Dac_mac_l:0x%x Dac_mac_h:0x%x\n", gImgEepromInfo.camNormdata[0][28], gImgEepromInfo.camNormdata[0][29]);
    LOG_INF("Dac_inf_l:0x%x Dac_inf_h:0x%x\n", gImgEepromInfo.camNormdata[0][34], gImgEepromInfo.camNormdata[0][35]);
    ...
    // }
    gImgEepromInfo.i4CurSensorIdx = 5;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    if (!_is_seamless) {
        if (reg_gain > 0xf80) {
            ...
            write_cmos_sensor(0x03509, 0x80);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    do {
        *sensor_id = return_sensor_id()+1;
        LOG_INF("return sensor id: 0x%x\n", return_sensor_id()+1);
        if (*sensor_id == MIAMI_AAC2_OV64B_SENSOR_ID) {
            LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n",
            imgsensor.i2c_write_id, *sensor_id);
            ov64b_vcm_id = Eeprom_1ByteDataRead(0x0A, 0xA0);
            LOG_INF("RENM0_module_id=%d\n",imgsensor_info.module_id);
            LOG_INF("miami vcm id: 0x%x\n", ov64b_vcm_id);
            if(ov64b_vcm_id == VCM_REG_MIAMI) {
                read_EepromQSC();
                *sensor_id = imgsensor_info.sensor_id;
			    LOG_INF("Find ov64b_miami_ii,vcm ID = 0x%x\n", ov64b_vcm_id);
					//return ERROR_NONE;
			} else {
				LOG_INF("Not Find ov64b_miami\n");
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        LOG_INF("zyd_get_imgsensor_id: 0x%x fail\n", imgsensor_info.sensor_id);
    ...
    *(feature_data + 1) = imgsensor_info.min_shutter;
    ...
    case SENSOR_FEATURE_GET_PDAF_INFO:
        ...
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
           case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
        case MSDK_SCENARIO_ID_CUSTOM1:
            memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info,//4624*3468
                sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_video,//4624*2600
                sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
        case MSDK_SCENARIO_ID_CUSTOM2:
            memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_custom2,//3840*2160
                sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
        case MSDK_SCENARIO_ID_CUSTOM4:
            memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_custom4,//4000*3000
                sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
        #if 0
        case MSDK_SCENARIO_ID_CUSTOM5:
